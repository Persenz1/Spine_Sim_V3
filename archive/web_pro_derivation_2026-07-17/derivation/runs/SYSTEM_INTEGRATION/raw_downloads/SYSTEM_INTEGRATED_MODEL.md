...
|---:|---|---|---|---|
| 1 | `engineering_fixed_context` | `engineering_fixed_context(13).md` | `1.0.0 current` | `6c1225d3137f8095673b78e1dc8a76acdb0ae73247ec7c49e720cfcc56bb03cb` |
| 2 | `A_INTEGRATED_MODEL` | `A_INTEGRATED_MODEL(1).md` | `1.0.0 accepted` | `0679f5bfe71d2ff5b2521414a39b41c6b94f23f54227d19bd38a964960088ccc` |
| 3 | `B_INTEGRATED_MODEL` | `B_INTEGRATED_MODEL(1).md` | `1.0.0 accepted` | `d64a387956b4d8b2317817c7429d1a57e594bab436fc5f1c9547126c95dd43ad` |
| 4 | `C_INTEGRATED_MODEL` | `C_INTEGRATED_MODEL(1).md` | `1.0.0 accepted` | `8439835281ed61344de106082f8e6826c9a993d8767fb7845633510cdfe5b589` |
...
| `W_U^{O_A}` | wrench | 全部针 `A_on_B` 运输到 `O_A` 后的 contact-only 和 | B → C | declared frame, `O_A`; N、N·mm | trial/accepted | `contact_only_wrench` |
